...
class BookingController {
  ...
  public getProperties = async (req: Request, res: Response) => {
    ...
    logger.info(`Retrieved ${paginatedProperties.length} Booking.com properties`);
    res.json(response);
  };
  ...
  public getProperty = async (req: Request, res: Response) => {
    ...
    logger.info(`Retrieved Booking.com property: ${id}`);
    res.json(response);
  };
  ...
  public createProperty = async (req: Request, res: Response) => {
    ...
    websocketService.broadcastPropertyUpdate('booking', property);
    ...
    logger.info(`Created Booking.com property: ${property.id}`);
  ...
  public updateProperty = async (req: Request, res: Response) => {
    ...
    logger.info(`Updated Booking.com property: ${id}`);
    res.json(response);
  };
  ...
  public deleteProperty = async (req: Request, res: Response) => {
    ...
    // Broadcast update via WebSocket
    websocketService.broadcastPropertyUpdate('booking', { id, deleted: true });
    ...
    logger.info(`Deleted Booking.com property: ${id}`);
    res.json(response);
  };
  ...
  public getReservations = async (req: Request, res: Response) => {
    ...
    let bookings = dataGenerator.getData().bookings.filter(b => b.channel === 'booking');
    ...
    logger.info(`Retrieved ${paginatedBookings.length} Booking.com reservations`);
    res.json(response);
  };
  ...
  public getReservation = async (req: Request, res: Response) => {
    ...
    if (!booking || booking.channel !== 'booking') {
    ...
    logger.info(`Retrieved Booking.com reservation: ${id}`);
    res.json(response);
  };
  ...
  public createReservation = async (req: Request, res: Response) => {
    ...
    const booking: MockBooking = {
      id: `booking_reservation_${Date.now()}_${Math.random().toString(36).substring(7)}`,
      ...
      status: 'confirmed',
      channel: 'booking',
      channelBookingId: `BOOKING${Date.now()}`,
      createdAt: new Date(),
      updatedAt: new Date()
    };
    ...
    // Broadcast update via WebSocket
    websocketService.broadcastBookingUpdate('booking', booking);
    ...
    logger.info(`Created Booking.com reservation: ${booking.id}`);
    res.status(201).json(response);
  };
  ...
  public updateReservation = async (req: Request, res: Response) => {
    ...
    // Broadcast update via WebSocket
    websocketService.broadcastBookingUpdate('booking', updatedBooking);
    ...
    logger.info(`Updated Booking.com reservation: ${id}`);
    res.json(response);
  };
  ...
  public cancelReservation = async (req: Request, res: Response) => {
    ...
    // Broadcast update via WebSocket
    websocketService.broadcastBookingUpdate('booking', cancelledBooking);
    ...
    logger.info(`Cancelled Booking.com reservation: ${id}`);
    res.json(response);
  };
  ...
  public getRatePlans = async (req: Request, res: Response) => {
    ...
    logger.info(`Retrieved ${ratePlans.length} Booking.com rate plans for property: ${propertyId}`);
    res.json(response);
  };
  ...
  public createRatePlan = async (req: Request, res: Response) => {
    ...
    const ratePlan: MockRatePlan = {
      id: `booking_rate_${Date.now()}_${Math.random().toString(36).substring(7)}`,
    ...
    // Broadcast update via WebSocket
    websocketService.broadcastRateUpdate('booking', ratePlan);
    ...
    logger.info(`Created Booking.com rate plan: ${ratePlan.id}`);
    res.status(201).json(response);
  };
  ...
  public getAvailability = async (req: Request, res: Response) => {
    ...
    logger.info(`Retrieved ${calendars.length} Booking.com availability entries for property: ${propertyId}`);
    res.json(response);
  };
  ...
  public updateAvailability = async (req: Request, res: Response) => {
    ...
    updates.forEach((update: any) => {
      ...
      if (existingCalendar) {
        ...
        const newCalendar: MockCalendar = {
          id: `booking_cal_${Date.now()}_${Math.random().toString(36).substring(7)}`,
          propertyId,
    ...
    // Broadcast update via WebSocket
    websocketService.broadcastCalendarUpdate('booking', { propertyId, updates });
    ...
    logger.info(`Updated Booking.com availability for property: ${propertyId}`);
    res.json(response);
  };
}
